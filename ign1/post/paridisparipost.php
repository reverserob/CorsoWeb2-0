    <?php 
	  if($_POST['but1']!="invio") //testualmente questo codice dice "se è stato cliccato il bottone but1 della pagina html..." inoltre da come potete vedere ovviamente i dati inviati dal bottone saranno elaborati in metodo post
	{?>
	<?php
	}
	...
	{
		if($_POST['num']%2==0) // dice "se il numero inviato dal bottone è uguale a 2...". qui comincia l'elaborazione del dato utilizzando un if e un else (se / altrimenti)
